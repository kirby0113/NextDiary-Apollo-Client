...
export type DiariesQuery = {
  __typename?: "Query";
  getDiaries: Array<{ __typename?: "Diary"; id: string; title: string }>;
};
...
export type DiaryQuery = {
  __typename?: "Query";
  getDiary: { __typename?: "Diary"; id: string; title: string };
};
...
export function getSdk(
  ...
  return {
    Diaries(
      variables: DiariesQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<DiariesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DiariesQuery>(DiariesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Diaries",
    ...
    Diary(
      variables: DiaryQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<DiaryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DiaryQuery>(DiaryDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Diary",
